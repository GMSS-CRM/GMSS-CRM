...
export interface IVendorRepository extends Repository<Vendor> {
  ...
  search(params: { search?: string; status?: VendorStatus; type?: VendorType; limit?: number; offset?: number }): Promise<Vendor[]>;
...
export interface IVendorService {
  createVendor(input: any, actor?: { email?: string }): Promise<Vendor>;
