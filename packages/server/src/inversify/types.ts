export const TYPES = {
  ...
  IVendorAgreementRepository: Symbol.for('IVendorAgreementRepository'),
  IVendorAgreementService: Symbol.for('IVendorAgreementService'),

  IVendorWorkflowRepository: Symbol.for('IVendorWorkflowRepository'),
  IVendorWorkflowService: Symbol.for('IVendorWorkflowService'),

  IVendorApprovalRepository: Symbol.for('IVendorApprovalRepository'),
  IVendorApprovalService: Symbol.for('IVendorApprovalService'),

  IVendorProposalRepository: Symbol.for('IVendorProposalRepository'),
  IVendorProposalService: Symbol.for('IVendorProposalService'),

  IVendorCommissionService: Symbol.for('IVendorCommissionService'),

  IVendorFollowUpRepository: Symbol.for('IVendorFollowUpRepository'),
  IVendorFollowUpService: Symbol.for('IVendorFollowUpService'),
  IVendorPaymentService: Symbol.for('IVendorPaymentService'),
